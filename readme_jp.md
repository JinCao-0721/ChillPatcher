...
#### Bilibili 音楽モジュール — 作者: [@xiaogouqianqian](https://github.com/xiaogouqianqian)
- **🔓 QRコードログイン**：Bilibili QRコードスキャンログインを内蔵
- **📂 お気に入りフォルダ同期**：すべてのBilibiliお気に入りフォルダを自動読み込み
- **🎧 ストリーミング再生**：ダウンロードしながら再生、10秒のリングバッファ
- **🖼️ スマートカバー**：動画のカバー画像を自動的に正方形に中央トリミング
- **API**: Bilibili 公式 API（`api.bilibili.com`、`passport.bilibili.com`）を使用
- 詳細: [Bilibili モジュール README](ChillPatcher.Module.Bilibili/README.md)

#### QQ 音楽モジュール — 作者: [@JinCao-0721](https://github.com/JinCao-0721)
- **🎵 複数音質対応**：標準(128k)、HQ(320k)、ロスレス(FLAC)、Hi-Res の4段階
- **🎧 ストリーミング再生**：ダウンロードしながら再生、MP3/FLAC 対応
- **❤️ お気に入り同期**：お気に入り/解除をリアルタイムでQQ音楽サーバーに同期
- **📋 プレイリスト管理**：「お気に入り」と「デイリーレコメンド」を自動読み込み、カスタムプレイリストのインポートにも対応
- **🔑 Cookie ログイン**：ブラウザの `y.qq.com` から Cookie をコピーして設定ファイルに貼り付け
- **API**: ネイティブ Go ブリッジ DLL を通じて QQ 音楽公式インターフェースを呼び出し
- 詳細: [QQ 音楽モジュール README](ChillPatcher.Module.QQMusic/README.md)
...
オープンソースライセンスの互換性に基づき、ChillPatcher 全体は GPL v3 ライセンスとなります。詳細は [LICENSE](LICENSE) ファイルを参照してください。
...
### モジュール貢献者
- [@xiaogouqianqian](https://github.com/xiaogouqianqian) - Bilibili 音楽モジュール原作者
- [@JinCao-0721](https://github.com/JinCao-0721) - QQ 音楽モジュール原作者
...
### オープンソースプロジェクト
  ...
  - [dr\_libs](https://github.com/mackron/dr_libs) - FLAC/WAV/MP3 オーディオデコード
  - [fdk-aac](https://github.com/mstorsjo/fdk-aac) - AAC オーディオデコードサポート
  - [minimp4](https://github.com/lieff/minimp4) - MP4/FMP4 デマルチプレクササポート
  - [go-musicfox](https://github.com/go-musicfox/go-musicfox) - ストリーミングクライアントサポート
