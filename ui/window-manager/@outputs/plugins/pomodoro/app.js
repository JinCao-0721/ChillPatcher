...
var PomodoroCompact = () => {
  ...
  const cbtn = (t, on, bg = "rgba(125,211,252,0.15)", color = ACCENT) => /* @__PURE__ */ createElement("div", { onPointerDown: on, style: { fontSize: 11, color, backgroundColor: bg, borderRadius: 6, paddingLeft: 8, paddingRight: 8, paddingTop: 4, paddingBottom: 4 } }, t);
